...
#CMD ["gunicorn", "--bind", "0.0.0.0:5000", "test_app:class_app"]
CMD ["gunicorn", "--bind", "0.0.0.0:5000", "--access-logfile", "-", "--error-logfile", "-", "--capture-output", "--log-level", "info", "test_app:app"]
